...
python benchmarks/bench_semantic_cache.py --compare --out docs/evidence/semantic-cache-onnx-v2.6.0.json --markdown docs/evidence/semantic-cache-onnx-v2.6.0.md
