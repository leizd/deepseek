...
python benchmarks/bench_semantic_cache.py --compare --out docs/evidence/semantic-cache-onnx-v2.5.5.json --markdown docs/evidence/semantic-cache-onnx-v2.5.5.md
