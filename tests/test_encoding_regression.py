...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_v086_reasoning_timer_and_busy_interactions_are_present(self) -> None:
        ...
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.4.1-blue", readme)
        self.assertIn("## [0.8.6]", changelog)
        self.assertIn("适用版本：v2.4.1。", api)
    ...
    def test_v170_streaming_phase_labels_and_timer_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.4.1"', config)
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.4.1-blue", readme)
    ...
    def test_v096_search_hotfix_and_tool_expansion_are_present(self) -> None:
        ...
        self.assertIn("适用版本：v2.4.1。", api)
        self.assertIn("适用版本：v2.4.1。", security)
    ...
    def test_v162_android_ocr_bridge_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.4.1"', build_gradle)
    ...
    def test_v166_gemini_skin_and_frontend_fixes_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.4.1"', config)
        self.assertIn('versionName "2.4.1"', build_gradle)
        self.assertIn("versionCode 241", build_gradle)
        self.assertIn("version-2.4.1-blue", readme)
    ...
    def test_v229_release_readiness_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.4.1"', build_gradle)
        self.assertIn("versionCode 241", build_gradle)
        self.assertIn("deepseek-infra:2.4.1", dockerfile)
        ...
        self.assertIn("scripts/preflight_release.py --version 2.4.1", readme)
        self.assertIn("scripts/smoke_release.py --offline", readme)
        self.assertIn("release-readiness", ci)
        self.assertIn("preflight_release.py --version 2.4.1", ci)
    ...
    def test_v232_headless_mcp_client_compatibility_pack_is_present(self) -> None:
        ...
        self.assertIn("Claude Desktop | 🟡", compatibility)
        self.assertIn("Cursor | 🟡", compatibility)
        ...
        self.assertEqual(evidence["version"], "2.4.1")
    ...
    def test_v241_release_evidence_patch_is_present(self) -> None:
        ...
        self.assertEqual(headless_evidence["version"], "2.4.1")
        self.assertEqual(a2a_evidence["version"], "2.4.1")
        self.assertEqual(latest_report["version"], "2.4.1")
        self.assertEqual(agent_report["version"], "2.4.1")
        self.assertEqual(compare_report["version"], "2.4.1")
        self.assertEqual(security_report["version"], "2.4.1")
