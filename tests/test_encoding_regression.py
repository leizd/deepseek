...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_v086_reasoning_timer_and_busy_interactions_are_present(self) -> None:
        ...
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.6.1-blue", readme)
        self.assertIn("## [0.8.6]", changelog)
        self.assertIn("适用版本：v2.6.1。", api)
    ...
    def test_v170_streaming_phase_labels_and_timer_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.6.1"', config)
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.6.1-blue", readme)
    ...
    def test_v096_search_hotfix_and_tool_expansion_are_present(self) -> None:
        ...
        self.assertIn("适用版本：v2.6.1。", api)
        self.assertIn("适用版本：v2.6.1。", security)
    ...
    def test_v162_android_ocr_bridge_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.6.1"', build_gradle)
    ...
    def test_v166_gemini_skin_and_frontend_fixes_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.6.1"', config)
        self.assertIn('versionName "2.6.1"', build_gradle)
        self.assertIn("versionCode 261", build_gradle)
        self.assertIn("version-2.6.1-blue", readme)
    ...
    def test_v229_release_readiness_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.6.1"', build_gradle)
        self.assertIn("versionCode 261", build_gradle)
        self.assertIn("deepseek-infra:2.6.1", dockerfile)
        ...
        self.assertIn("scripts/preflight_release.py --version 2.6.1", readme)
        self.assertIn("scripts/smoke_release.py --offline", readme)
        self.assertIn("release-readiness", ci)
        self.assertIn("preflight_release.py --version 2.6.1", ci)
    ...
    def test_v232_headless_mcp_client_compatibility_pack_is_present(self) -> None:
        ...
        self.assertEqual(evidence["version"], "2.6.1")
    ...
    def test_v241_release_evidence_patch_is_present(self) -> None:
        ...
        self.assertEqual(headless_evidence["version"], "2.6.1")
        self.assertEqual(a2a_evidence["version"], "2.6.1")
        self.assertEqual(latest_report["version"], "2.6.1")
        self.assertEqual(agent_report["version"], "2.6.1")
        self.assertEqual(compare_report["version"], "2.6.1")
        self.assertEqual(security_report["version"], "2.6.1")
    ...
    def test_v250_workspace_core_is_present(self) -> None:
        ...
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        workspace_evidence = json.loads(Path("docs/evidence/workspace-v2.6.1.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("Workspace Core Evidence（v2.6.1）", readiness)
        self.assertIn("workspace_core_evidence", evidence_index)
        self.assertIn("docs/evidence/workspace-v2.6.1.json", evidence_index)
        ...
        self.assertIn("docs/evidence/workspace-v2.6.1.json", manifest)
        self.assertIn("smoke_workspace.py --offline --out docs/evidence/workspace-v2.6.1.json", ci)
        self.assertEqual(workspace_evidence["version"], "2.6.1")
    ...
    def test_v261_skill_api_integration_patch_is_present(self) -> None:
        readme = Path("README.md").read_text(encoding="utf-8")
        changelog = Path("CHANGELOG.md").read_text(encoding="utf-8")
        ...
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skills-v2.6.1.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("## [2.6.1] - Skill API Integration Patch", changelog)
        self.assertIn("### v2.6.1: Skill API Integration Patch", readme)
        self.assertIn("Applicable version: v2.6.1.", skills_doc)
        ...
        self.assertIn("smoke_skills.py --offline --out docs/evidence/skills-v2.6.1.json", ci)
        self.assertIn("docs/evidence/skills-v2.6.1.json", evidence_index)
        self.assertIn("Skill System Evidence（v2.6.1）", readiness)
        self.assertIn("_env_path", config)
        self.assertEqual(evidence["version"], "2.6.1")
        self.assertEqual(evidence["status"], "PASS")
        self.assertEqual(evidence["checks"]["skillApiRoutes"], "PASS")
        self.assertEqual(skill_eval["version"], "2.6.1")
