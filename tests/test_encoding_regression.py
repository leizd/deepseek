...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_v086_reasoning_timer_and_busy_interactions_are_present(self) -> None:
        ...
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.3.4-blue", readme)
        self.assertIn("## [0.8.6]", changelog)
        self.assertIn("适用版本：v2.3.4。", api)
    ...
    def test_v170_streaming_phase_labels_and_timer_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.3.4"', config)
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.3.4-blue", readme)
    ...
    def test_v096_search_hotfix_and_tool_expansion_are_present(self) -> None:
        ...
        self.assertIn("适用版本：v2.3.4。", api)
        self.assertIn("适用版本：v2.3.4。", security)
    ...
    def test_v162_android_ocr_bridge_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.3.4"', build_gradle)
    ...
    def test_v166_gemini_skin_and_frontend_fixes_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.3.4"', config)
        self.assertIn('versionName "2.3.4"', build_gradle)
        self.assertIn("versionCode 234", build_gradle)
        self.assertIn("version-2.3.4-blue", readme)
    ...
    def test_v227_eval_reports_regression_evidence_is_present(self) -> None:
        ...
        self.assertIn("run_offline_eval_suite.py --out evals/reports/latest.json", ci)
    ...
    def test_v228_agent_eval_replay_stability_is_present(self) -> None:
        ...
        self.assertIn("run_agent_eval.py --report-dir evals/reports --report-only", evals_readme)
        ...
        self.assertIn("Agent replay 已生成 report-only artifact", status_doc)
        self.assertIn("run_agent_eval.py --report-dir evals/reports --report-only", ci)
    ...
    def test_v229_release_readiness_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.3.4"', build_gradle)
        self.assertIn("versionCode 234", build_gradle)
        self.assertIn("deepseek-infra:2.3.4", dockerfile)
        ...
        self.assertIn("scripts/preflight_release.py --version 2.3.4", readme)
        self.assertIn("scripts/smoke_release.py --offline", readme)
        self.assertIn("release-readiness", ci)
        self.assertIn("preflight_release.py --version 2.3.4", ci)
    ...
    def test_v232_headless_mcp_client_compatibility_pack_is_present(self) -> None:
        ...
        self.assertEqual(evidence["version"], "2.3.4")
    ...
    def test_v234_release_evidence_polish_is_present(self) -> None:
        ...
        self.assertEqual(headless_evidence["version"], "2.3.4")
        self.assertEqual(a2a_evidence["version"], "2.3.4")
        self.assertEqual(latest_report["version"], "2.3.4")
        self.assertEqual(agent_report["version"], "2.3.4")
        for evidence in (headless_evidence, a2a_evidence, latest_report, agent_report):
