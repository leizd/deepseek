...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_v086_reasoning_timer_and_busy_interactions_are_present(self) -> None:
        ...
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.5.4-blue", readme)
        self.assertIn("## [0.8.6]", changelog)
        self.assertIn("适用版本：v2.5.4。", api)
    ...
    def test_v170_streaming_phase_labels_and_timer_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.5.4"', config)
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.5.4-blue", readme)
    ...
    def test_v096_search_hotfix_and_tool_expansion_are_present(self) -> None:
        ...
        self.assertIn("适用版本：v2.5.4。", api)
        self.assertIn("适用版本：v2.5.4。", security)
    ...
    def test_v162_android_ocr_bridge_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.5.4"', build_gradle)
    ...
    def test_v166_gemini_skin_and_frontend_fixes_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.5.4"', config)
        self.assertIn('versionName "2.5.4"', build_gradle)
        self.assertIn("versionCode 254", build_gradle)
        self.assertIn("version-2.5.4-blue", readme)
    ...
    def test_v229_release_readiness_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.5.4"', build_gradle)
        self.assertIn("versionCode 254", build_gradle)
        self.assertIn("deepseek-infra:2.5.4", dockerfile)
        ...
        self.assertIn("scripts/preflight_release.py --version 2.5.4", readme)
        self.assertIn("scripts/smoke_release.py --offline", readme)
        self.assertIn("release-readiness", ci)
        self.assertIn("preflight_release.py --version 2.5.4", ci)
    ...
    def test_v232_headless_mcp_client_compatibility_pack_is_present(self) -> None:
        ...
        self.assertEqual(evidence["version"], "2.5.4")
    ...
    def test_v241_release_evidence_patch_is_present(self) -> None:
        ...
        self.assertEqual(headless_evidence["version"], "2.5.4")
        self.assertEqual(a2a_evidence["version"], "2.5.4")
        self.assertEqual(latest_report["version"], "2.5.4")
        self.assertEqual(agent_report["version"], "2.5.4")
        self.assertEqual(compare_report["version"], "2.5.4")
        self.assertEqual(security_report["version"], "2.5.4")
    ...
    def test_v250_workspace_core_is_present(self) -> None:
        ...
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        workspace_evidence = json.loads(Path("docs/evidence/workspace-v2.5.4.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("## [2.5.4] - Web Route Split Phase 1", changelog)
        self.assertIn("### v2.5.4: Web Route Split Phase 1", readme)
        ...
        self.assertIn("Workspace Core Evidence（v2.5.4）", readiness)
        self.assertIn("workspace_core_evidence", evidence_index)
        self.assertIn("docs/evidence/workspace-v2.5.4.json", evidence_index)
        ...
        self.assertIn("docs/evidence/workspace-v2.5.4.json", manifest)
        self.assertIn("smoke_workspace.py --offline --out docs/evidence/workspace-v2.5.4.json", ci)
        self.assertEqual(workspace_evidence["version"], "2.5.4")
