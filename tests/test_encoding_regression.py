...
class EncodingRegressionTests(unittest.TestCase):
    ...
    def test_v086_reasoning_timer_and_busy_interactions_are_present(self) -> None:
        ...
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.6.8-blue", readme)
        self.assertIn("## [0.8.6]", changelog)
        self.assertIn("适用版本：v2.6.8。", api)
    ...
    def test_v170_streaming_phase_labels_and_timer_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.6.8"', config)
        self.assertIn("deepseek-infra-v187", sw)
        self.assertIn("version-2.6.8-blue", readme)
    ...
    def test_v096_search_hotfix_and_tool_expansion_are_present(self) -> None:
        ...
        self.assertIn("适用版本：v2.6.8。", api)
        self.assertIn("适用版本：v2.6.8。", security)
    ...
    def test_v162_android_ocr_bridge_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.6.8"', build_gradle)
    ...
    def test_v166_gemini_skin_and_frontend_fixes_are_present(self) -> None:
        ...
        self.assertIn('app_version: str = "2.6.8"', config)
        self.assertIn('versionName "2.6.8"', build_gradle)
        self.assertIn("versionCode 268", build_gradle)
        self.assertIn("version-2.6.8-blue", readme)
    ...
    def test_v229_release_readiness_is_present(self) -> None:
        ...
        self.assertIn('versionName "2.6.8"', build_gradle)
        self.assertIn("versionCode 268", build_gradle)
        self.assertIn("deepseek-infra:2.6.8", dockerfile)
        ...
        self.assertIn("scripts/preflight_release.py --version 2.6.8", readme)
        self.assertIn("scripts/smoke_release.py --offline", readme)
        self.assertIn("release-readiness", ci)
        self.assertIn("preflight_release.py --version 2.6.8", ci)
    ...
    def test_v232_headless_mcp_client_compatibility_pack_is_present(self) -> None:
        ...
        self.assertEqual(evidence["version"], "2.6.8")
    ...
    def test_v241_release_evidence_patch_is_present(self) -> None:
        ...
        self.assertEqual(headless_evidence["version"], "2.6.8")
        self.assertEqual(a2a_evidence["version"], "2.6.8")
        self.assertEqual(latest_report["version"], "2.6.8")
        self.assertEqual(agent_report["version"], "2.6.8")
        self.assertEqual(compare_report["version"], "2.6.8")
        self.assertEqual(security_report["version"], "2.6.8")
    ...
    def test_v250_workspace_core_is_present(self) -> None:
        ...
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        workspace_evidence = json.loads(Path("docs/evidence/workspace-v2.6.8.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("Workspace Core Evidence（v2.6.8）", readiness)
        self.assertIn("workspace_core_evidence", evidence_index)
        self.assertIn("docs/evidence/workspace-v2.6.8.json", evidence_index)
        ...
        self.assertIn("docs/evidence/workspace-v2.6.8.json", manifest)
        self.assertIn("smoke_workspace.py --offline --out docs/evidence/workspace-v2.6.8.json", ci)
        self.assertEqual(workspace_evidence["version"], "2.6.8")
    ...
    def test_v263_custom_skill_builder_is_present(self) -> None:
        ...
        manifest = Path("deepseek_infra/infra/diagnostics/release_manifest.py").read_text(encoding="utf-8")
        ci = Path(".github/workflows/ci.yml").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skills-v2.6.8.json").read_text(encoding="utf-8"))
        ui_evidence = json.loads(Path("docs/evidence/skills-ui-v2.6.8.json").read_text(encoding="utf-8"))
        builder_evidence = json.loads(Path("docs/evidence/skill-builder-v2.6.8.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("Applicable version: v2.6.8.", skills_doc)
        ...
        self.assertIn("smoke_skills.py --offline --out docs/evidence/skills-v2.6.8.json", ci)
        self.assertIn("smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v2.6.8.json", ci)
        self.assertIn("smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v2.6.8.json", ci)
        self.assertIn("node --check static/modules/skills.js", ci)
        self.assertIn("docs/evidence/skills-v2.6.8.json", evidence_index)
        self.assertIn("docs/evidence/skills-ui-v2.6.8.json", evidence_index)
        self.assertIn("docs/evidence/skill-builder-v2.6.8.json", evidence_index)
        self.assertIn("Skill System Evidence（v2.6.8）", readiness)
        self.assertIn("Skill Workbench UI Evidence（v2.6.8）", readiness)
        self.assertIn("Skill Builder Evidence (v2.6.8)", readiness)
        self.assertIn("_env_path", config)
        self.assertEqual(evidence["version"], "2.6.8")
        self.assertEqual(evidence["status"], "PASS")
        self.assertEqual(evidence["checks"]["skillApiRoutes"], "PASS")
        self.assertEqual(ui_evidence["version"], "2.6.8")
        ...
        self.assertEqual(builder_evidence["version"], "2.6.8")
        ...
        self.assertEqual(skill_eval["version"], "2.6.8")
    ...
    def test_v264_skill_packs_is_present(self) -> None:
        ...
        styles = Path("static/styles.css").read_text(encoding="utf-8")
        build_gradle = Path("android/app/build.gradle").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-packs-v2.6.8.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("skill-packs-v2.6.8.json", manifest)
        self.assertIn("smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v2.6.8.json", ci)
        self.assertIn("node --check static/modules/skills.js", ci)
        ...
        self.assertIn("docs/evidence/skill-packs-v2.6.8.json", evidence_index)
        self.assertIn("scripts/smoke_skill_packs.py", evidence_index)
        self.assertIn("Skill Packs Evidence (v2.6.8)", readiness)
    ...
    def test_v265_skill_eval_dashboard_is_present(self) -> None:
        ...
        styles = Path("static/styles.css").read_text(encoding="utf-8")
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-eval-dashboard-v2.6.8.json").read_text(encoding="utf-8"))
        report = json.loads(Path("evals/reports/skills-v2.6.8.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("Skill eval report is `evals/reports/skills-v2.6.8.json`", skills_doc)
        ...
        self.assertIn("evals/reports/skills-v2.6.8.json", manifest)
        self.assertIn("smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v2.6.8.json", ci)
        ...
        self.assertIn("docs/evidence/skill-eval-dashboard-v2.6.8.json", evidence_index)
        ...
        self.assertEqual(report["version"], "2.6.8")
    ...
    def test_v266_skill_versioning_is_present(self) -> None:
        ...
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-versioning-v2.6.6.json").read_text(encoding="utf-8"))
        ...
        self.assertEqual(evidence["version"], "2.6.6")
        self.assertEqual(evidence["status"], "PASS")
        for check in (
    ...
    def test_v267_skill_run_analytics_is_present(self) -> None:
        ...
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-analytics-v2.6.8.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("docs/evidence/skill-analytics-v2.6.8.json", manifest)
        self.assertIn("smoke_skill_analytics.py --offline --out docs/evidence/skill-analytics-v2.6.8.json", ci)
        ...
        self.assertIn("docs/evidence/skill-analytics-v2.6.8.json", evidence_index)
    ...
    def test_v268_skill_security_review_is_present(self) -> None:
        ...
        web_route_tests = Path("tests/test_web_skills_routes.py").read_text(encoding="utf-8")
        evidence = json.loads(Path("docs/evidence/skill-security-v2.6.8.json").read_text(encoding="utf-8"))
        ...
        self.assertIn("docs/evidence/skill-security-v2.6.8.json", manifest)
        self.assertIn("smoke_skill_security.py --offline --out docs/evidence/skill-security-v2.6.8.json", ci)
        ...
        self.assertIn("docs/evidence/skill-security-v2.6.8.json", evidence_index)
