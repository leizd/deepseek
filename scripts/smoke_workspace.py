#!/usr/bin/env python3
"""Offline Workspace Core smoke for v2.5.4.
...
def run_workspace_smoke(root: Path) -> tuple[dict[str, str], dict[str, Any]]:
    ...
    project = projects.create_project("Workspace Smoke", description="v2.5.4 object model")
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--out", type=Path, default=REPO_ROOT / "docs" / "evidence" / "workspace-v2.5.4.json")
