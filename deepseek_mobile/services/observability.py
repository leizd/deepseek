...
from deepseek_mobile.core.config import TRACE_DB, TRACE_DIR, TRACE_ENABLED, TRACE_INPUT_CHARS, TRACE_LIST_LIMIT, TRACE_OUTPUT_CHARS

logger = logging.getLogger("deepseek_mobile.observability")
