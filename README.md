...
![版本](https://img.shields.io/badge/version-2.5.3-blue)
...
### v2.5.3: Edge/Ollama Cascade Draft Layer
...
- [x] Workspace Evidence：`python scripts/smoke_workspace.py --offline` 生成 `docs/evidence/workspace-v2.5.3.json`，preflight 与 release manifest 固化 `workspaceCore=PASS`
