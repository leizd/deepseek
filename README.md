...
![版本](https://img.shields.io/badge/version-2.6.8-blue)
...
| Skill Eval Dashboard | Skill Eval Case Builder |
| --- | --- |
| ![Skill Eval Dashboard](docs/assets/skill-eval-dashboard.png) | ![Skill Eval Case Builder](docs/assets/skill-eval-case-builder.png) |

| Skill Version History | Skill Version Diff |
| --- | --- |
| ![Skill Version History](docs/assets/skill-version-history.png) | ![Skill Version Diff](docs/assets/skill-version-diff.png) |

| Skill Security Review | Skill Trust Store |
| --- | --- |
| ![Skill Security Review](docs/assets/skill-security-review.png) | ![Skill Trust Store](docs/assets/skill-trust-store.png) |
...
**Release preflight (v2.6.8)**: Run `python scripts/doctor.py --offline`, `python scripts/smoke_workspace.py --offline --out docs/evidence/workspace-v2.6.8.json`, `python scripts/smoke_skills.py --offline --out docs/evidence/skills-v2.6.8.json`, `python scripts/smoke_skills_ui.py --offline --out docs/evidence/skills-ui-v2.6.8.json`, `python scripts/smoke_skill_builder.py --offline --out docs/evidence/skill-builder-v2.6.8.json`, `python scripts/smoke_skill_packs.py --offline --out docs/evidence/skill-packs-v2.6.8.json`, `python scripts/smoke_skill_eval_dashboard.py --offline --out docs/evidence/skill-eval-dashboard-v2.6.8.json --report-out evals/reports/skills-v2.6.8.json`, `python scripts/smoke_skill_versioning.py --offline --out docs/evidence/skill-versioning-v2.6.8.json`, `python scripts/smoke_skill_analytics.py --offline --out docs/evidence/skill-analytics-v2.6.8.json`, and `python scripts/smoke_skill_security.py --offline --out docs/evidence/skill-security-v2.6.8.json`; then run `python scripts/preflight_release.py --version 2.6.8` and `python scripts/smoke_release.py --offline`. Release manifest quality gates include `workspaceCore`, `skillSystem`, `skillWorkbench`, `skillBuilder`, `skillPacks`, `skillEvalDashboard`, `skillVersioning`, `skillAnalytics`, and `skillSecurity`.
...
- [x] Add Skill / Pack security review with trust levels, risk score, tool grant risk, suspicious prompt indicators, and review timestamps.
- [x] Add prompt injection, secret exfiltration, secret file access, network exfiltration, hidden tool instruction, and encoded-text static scans.
- [x] Add local trust store controls for `trust_skill`, `untrust_skill`, `block_skill`, tamper detection, and signing-prep hash manifests.
- [x] Add Security tab to Skill Workbench with summary cards, review rows, findings, manifest preview, and trust/block actions.
- [x] Add run security metadata into Skill analytics: `runSecurityLevel`, `securityReviewId`, `trustedAtRun`, `toolGrantHashAtRun`, `blockedReason`, and `approvalRequired`.
- [x] Add `scripts/smoke_skill_security.py --offline` and `docs/evidence/skill-security-v2.6.8.json`, with release readiness / preflight / CI gate `skillSecurity`.
...
- [x] Add rollback flows for custom Skills and custom Skill Packs.
- [x] Add versioned Project Pack Binding metadata with `packId`, `version`, and `installedAt`.
- [x] Add eval-aware upgrade gate for Pack upgrades and regression-risk summaries.
- [x] Add Skill Workbench Version History UI, version diff preview, migration summary, and rollback controls.
- [x] Add `scripts/smoke_skill_versioning.py --offline` and `docs/evidence/skill-versioning-v2.6.6.json`.

### v2.6.5: Skill Eval Dashboard
- [x] Add Skill Workbench Eval tab with Skill / Pack status, scores, case counts, failed cases, and recent run metadata.
...
### v2.6.4: Skill Packs
- [x] Add local Skill Pack (`.skillpack.json`) schema with packId / name / description / version / author / skills, supporting both references and embedded Skill configs.
- [x] Add Pack Import / Export / Validate with skillId conflict handling (error / overwrite / skip) and allowedTools permission diff.
- [x] Add built-in Template Library: Study / Research / Code / Office Skill Packs.
- [x] Add Packs tab to the Skill Workbench UI for viewing, installing, exporting, and deleting Packs with import summary and high-risk tool warnings.
- [x] Add Project Pack Binding (`enabledPacks`) and one-click Pack install to enable a set of Skills on a project.
- [x] Add `scripts/smoke_skill_packs.py --offline` and `docs/evidence/skill-packs-v2.6.4.json`, with CI / preflight / release manifest `skillPacks` gate.
