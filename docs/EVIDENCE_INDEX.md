...
| Release preflight | `python scripts/preflight_release.py --version 2.4.4` | exit 0 |
...
| --- | --- | --- |
| Release zip | `dist/deepseek-infra-2.4.4.zip` | 可分发源码包 |
| Checksum | `dist/deepseek-infra-2.4.4.zip.sha256` | 校验 zip 完整性 |
| Manifest | `dist/deepseek-infra-2.4.4.manifest.json` | 版本、commit、构建环境、evidence 清单与 `qualityGates` |
