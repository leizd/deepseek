...
发版前还要跑 `python scripts/preflight_release.py --version 2.2.9` 确认版本徽章 / CHANGELOG / Docker tag / eval 报告版本同步，详见 [docs/RELEASE_READINESS.md](RELEASE_READINESS.md) 与 [docs/RUNTIME_DOCTOR.md](RUNTIME_DOCTOR.md)。
