...
```bash
python benchmarks/bench_semantic_cache.py --compare --onnx-model /path/to/model.onnx --tokenizer /path/to/tokenizer.json --dimensions 384 --out docs/evidence/semantic-cache-onnx-v2.5.7.json --markdown docs/evidence/semantic-cache-onnx-v2.5.7.md
```
